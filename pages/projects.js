    ...
    <Layout>
      ...
      <div className={styles.wrapper}>
        <div className={styles.container}>
          ...
          <p>
            <span>Description:</span> QR Contact Tracer is a web application
        ...
        <div className={styles.container}>
          ...
          <p>
            <span>Description:</span> Recreated the well known game of
        ...
        <div className={styles.container}>
          ...
          <p>
            <span>Description:</span> Discover fields is a tool that allows
