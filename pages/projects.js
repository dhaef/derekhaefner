...
export default function Projects() {
    return (
        <Layout>
            ...
            <div className={styles.container}>
                <a href="https://www.vizlyte.com/"><img src="/vizlyte.png" loading="lazy" className={styles.pic} /></a>
            ...
            <div className={styles.container}>
                <a href="https://github.com/dhaef/ecom-sample"><img src="/react-ecom.png" loading="lazy" className={styles.pic} /></a>
