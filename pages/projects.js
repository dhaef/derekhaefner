    ...
    return (
        <Layout>
            ...
            <div className={styles.container}>
                <a href="https://www.qrcontacttracer.com/"><Image src="/qr-contact-tracer.png" width={1000} height={500} className={styles.pic} /></a>
            ...
            <div className={styles.container}>
                <a href="https://github.com/dhaef/discover_rei"><Image src="/xploreplaces.png" width={1000} height={500} className={styles.pic} /></a>
            ...
            <div className={styles.container}>
                <a href="https://www.vizlyte.com/"><Image src="/vizlyte.png" width={1000} height={500} className={styles.pic} /></a>
            ...
            <div className={styles.container}>
                <a href="https://github.com/dhaef/battleship"><Image src="/battleship.png" width={1000} height={500} className={styles.pic} /></a>
            ...
            <div className={styles.container}>
                <a href="http://www.discoverfields.com/"><Image src="/discoverfields.png" width={1000} height={500} className={styles.pic} /></a>
            ...
            <div className={styles.container}>
                <a href="https://github.com/dhaef/ecom-sample"><Image src="/react-ecom.png" width={1000} height={500} className={styles.pic} /></a>
